...
An interactive live-simulation implementation of the three local models can be found on the VisualPDE website at https://visualpde.com/mathematical-biology/Turing-conditions-are-not-enough.
